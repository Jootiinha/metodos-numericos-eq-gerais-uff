...
\begin{frame}{Conclusões dos Resultados}
\begin{block}{Principais Conclusões}
\begin{itemize}
\item MDFC2 é adequado para $k \leq 20$
\item Taxa de convergência $p \approx 2.0$ para $k$ pequeno
\item Poluição numérica limita eficiência para $k$ grande
\item Refinamento de malha essencial para $k$ médio/grande
\end{itemize}
\end{block}
\end{frame}
