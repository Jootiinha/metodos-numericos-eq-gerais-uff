...
\begin{column}{0.5\textwidth}
\begin{block}{Características de DF}
\begin{itemize}
\item \textbf{Vantagens}: Simplicidade, matriz esparsa, paralelização
\item \textbf{Desvantagens}: Malhas uniformes, poluição numérica para $k$ grande
\item \textbf{Aplicação}: Adequado para domínios retangulares
\end{itemize}
\end{block}
\end{column}
\end{columns}
