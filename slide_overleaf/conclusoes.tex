...
\begin{frame}{Conclusões - Resultados Principais}
\begin{block}{Principais Conclusões}
\begin{itemize}
...
\begin{frame}{Conclusões - Limitações Identificadas}
...
\begin{frame}{Validação - Conformidade com Teoria}
\begin{block}{Validação Numérica}
\begin{itemize}
...
\begin{frame}{Validação - Comparação com Literatura}
\begin{block}{Consistência com Literatura}
\begin{itemize}
...
\begin{frame}{Perspectivas Futuras - Melhorias Metodológicas}
...
\begin{frame}{Perspectivas Futuras - Integração com IA}
\begin{block}{Aplicações de IA}
\begin{itemize}
...
\begin{frame}{Perspectivas Futuras - Extensões}
